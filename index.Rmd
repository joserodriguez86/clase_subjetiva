...
##############Para la próxima incorporar a los conyuges en la ENES#############################.
...
```{r tamaños muestrales, message=F, warning=F}
...
muestra <- flextable::flextable(muestra) %>%  
  flextable::set_header_labels(values = list(V1 = "1960", V2="2003-4", V3="2007-8", V4="2009-10",
                                  V5="2014-15", V6="2021", V7="1995", V8="1999", 
                                  V9="2006", V10="2013", V11="2017", V12="2011", 
                                  V13="2013", V14="2015", V15="2017", V16="2018", 
                                  V17="2020")) %>% 
  flextable::add_header_row(values = c("Encuestas nacionales", "WVS",
                                              "Latinobarómetro"),
                          colwidths = c(6, 5, 6)) %>% 
  flextable::theme_box() %>% 
...
```{r clase subjetiva, message=F, warning=F, fig.cap="Posicionamiento de clase subjetivo. GBA 1960. Argentina 2003-2021"}
barra1960 <- base1960 %>%
  drop_na(q36_f) %>%
  group_by(q36_f) %>%
  tally() %>%
...
barras_1960_2021 <- grid.arrange(barra1960, barra2003, barra2007, barra2010,
                                barra2015, barra2021, ncol = 3,
                                bottom = textGrob("Fuente: elaboración propia en base a encuestas de hogares 1960-2021",
    gp = gpar(fontsize = 9),
    hjust = .1))

ggsave(barras_1960_2021, filename = "salidas/barras_subjetiva_1960_2021.jpg", dpi = 300, width = 8, height = 6)

barras_1960_2021

```

```{r clase subjetiva wvs, message=F, warning=F, fig.cap="Posicionamiento de clase subjetivo. Argentina 1984-2017"}
wvs %>%
  ...
  geom_text(aes(label = scales::percent(porcentaje, accuracy = 0.1),
                y = porcentaje + 0.01),
            position = position_dodge(.9), vjust = 0, size = 2.5) +
  labs(caption = "Fuente: elaboración propia en base a World Values Survey Time-Series (1981-2020)") +
  theme(axis.title.y = element_blank(),
        axis.title.x = element_blank(),
        plot.title = element_text(size = 12),
...
ggsave(filename = "salidas/barras_subjetiva_wvs.jpg", dpi = 300, width = 8, height = 6)

```

```{r clase subjetiva latinobarometro, message=F, warning=F, fig.cap="Posicionamiento de clase subjetivo. Argentina 2011-2020"}
latino %>%
  drop_na(clase_sub_f) %>%
...
ggsave(filename = "salidas/barras_subjetiva_latinobarometro.jpg", dpi = 300, width = 8, height = 6)

```

```{r clase objetiva, message=F, warning=F, fig.cap="Posicionamiento de clase objetivo. GBA 1960. Argentina 2003-2021"}
...
clase_objetiva <- grid.arrange(barra1960, barra2003, barra2007, barra2010,
                                barra2015, barra2021,
                                ncol = 3,
                                bottom = textGrob("Fuente: elaboración propia en base a encuestas de hogares 1960-2021",
    gp = gpar(fontsize = 9),
...
ggsave(clase_objetiva, filename = "salidas/barras_subjetiva_1960_2021.jpg", dpi = 300, width = 8, height = 6)

clase_objetiva

```

```{r comparacion clase obj-sub, message=F, warning=F, fig.cap="Composición de clase subjetiva según posicionamiento objetivo. GBA 1960. Argentina 2003-2021"}
...
ggsave(barra_obj_subj, filename = "salidas/barras_objetiva_1960_2021.jpg", dpi = 300, width = 8, height = 6)
...
```{r consistencia, message=F, warning=F, fig.cap="Consistencia de clase. GBA 1960. Argentina 2003-2021"}
barra1960 <- base1960 %>%
...
consistencia <- ggarrange(barra1960, barra2003, barra2007, barra2010,
                                barra2015, barra2021,
                                ncol = 3, nrow = 2, 
...
consistencia <- annotate_figure(consistencia, 
                                  bottom = text_grob("Fuente: elaboración propia en base a encuestas de hogares 1960-2021", hjust = 1, x = 1, size = 9)) +
  bgcolor("white") +
  border("white")

ggsave(consistencia, filename = "salidas/consistencia.jpg", dpi = 300, width = 8, height = 6)
...
base2021 %>%
  ...
  tbl_svysummary(include = c(egp5_f, egp5_origen_f, nivel_ed_f, sexo_f,
...
reg_coef +
  labs(caption = "Fuente: elaboración propia en base a encuesta ESAyPP / PISAC COVID 19 (2021)", x = "Razones de momios") +
  theme(axis.title.y = element_blank(),
        axis.title.x = element_blank(),
        axis.text.x = element_text(size = 8),
...
ggsave(filename = "salidas/coef_graf.jpg", dpi = 300, width = 8, height = 6)
...
reg_multinomial %>% 
  set_caption("Regresión multinomial. Categoría de referencia: clase baja") %>% 
  map_background_color(-1, -1, by_regex(
        "\\*" = "yellow"
      ))
...
El pseudo R2 es de **```r DescTools::PseudoR2(multinomial)```**.
